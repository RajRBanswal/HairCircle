...
class UserController extends Controller
{
  ...
  public function lucky_coupon()
   {
      return view('lucky_coupon');
   }
   public function withdraw_details()
   {
    ...
    //                     ->get();
      ...
      $data['details']= DB::table('transactions')
                     ->where("user_id",$id)
                     ->get();
   ...
   public function wallet_report()
   {
    ...
    public function withdraw()
    {
        ...
        // Last Request for Withdraw
        
           $da['last_user_with_amt']= DB::table('withdraw_requests')
    ...
    public function withdraw_amount(Request $request)
    {
        ...
        $user_id=DB::select(DB::raw('SELECT id from banks where id=:id'),array(
            ...
            if($user_id)
            {
                ...
                if($validatedData->fails())
                {
                    ...
                    if($total_amount>=500 and $user_count>=2)
                    {
                        ...
                        if($withdraw_amount>$total_amount)
                        {
                            ...
                            $user->save();
                            return Redirect::back()->with('success', 'Your withdraw amount request sent successfully');    
                        }
                ...
                //
                 return Redirect::back()->with('user_count', 'Your kyc not completed. Please complete your kyc.');
            }
