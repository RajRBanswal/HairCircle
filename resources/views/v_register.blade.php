...
<div class="container">
	<div class="card mb-5 mt-3">
		<div class="card-header abc">
			<center><h3>VENDOR REGISTRATION</h3></center>
		</div>
		<div class="card-body">
			<form method="post" action="{{ url('/v_register') }}" id="myform1" class="basicform" enctype="multipart/form-data">
     		@csrf
     		    <div class="row">
     		        <h3>Owner Details</h3>
     		    </div>
     			<div class="row">
				    <div class="form-group col-md-6">
				      ...
				      <input type="text" class="form-control" id="name" name="name" placeholder="Enter Your Name" required="enter name">
				    </div>
    		<!--		<div class="form-group col-md-6">-->
					 <!-- <div>-->
    ...
    <!--			<div class="row">-->
    <!--			     <div class="form-group col-md-6"> -->
				<!--		<label for="state">State</label><span class="required" style="color: red;">*</span>-->
				...
				<!--</div>-->
 		 		<!--<div class="row">-->
				    <!--<div class="form-group col-md-6">-->
				    <!--  	<label for="Shop Address">Address</label><span class="required" style="color: red;">*</span>-->
  				...
  				<div class="row">
      				...
      				<div class="form-group col-md-6">
      					...
      					<input type="password" class="form-control" name="password" id="password" placeholder="Password" required onkeyup="Get_Percent();">
    				</div>
    			</div>
  				<div class="row">
  				    <div class="form-group col-md-6">
				...
				<!--      	<input type="text" class="form-control" name="s_license" id="s_license" placeholder="Shop Name" >-->
				<!--    </div>-->
				<!--</div>-->
    <!--			<div class="row">-->
    			    <div class="form-group col-md-6">
				      	<label for="Shop Logo">Shop Logo</label>
				      	<input type="file" class="form-control" name="shoplogo" id="shop_logo" placeholder="Shop Logo" >
				    </div>
				    <!--<div class="form-group col-md-6">-->
