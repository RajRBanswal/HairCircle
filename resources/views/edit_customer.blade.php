...
<div class="container mt-5 mb-5">
	<div class="card p-2">
			...
			<h3 class="ml-4 mt-3">Edit Profile</h3>
		...
		<div class="card-body">
			...
			<div class="container">
				...
				<form method="post" action="{{ url('/update_customer',$cust->id) }}" class="basicform" enctype="multipart/form-data">
	     		@csrf
				  	<div class="row">
					    <div class="form-group col-md-6">
					      <label for="name">Name</label>
					      <input type="text" class="form-control" id="name" name="name" value="{{$cust->name}}" onchange="messages()">
					    </div>
					    <div class="form-group col-md-4">
					      <label for="dob">Date Of Birth</label>
					      <input type="date" class="form-control" value="{{$cust->date_of_birth}}" name="dob" id="dob" onchange="getAge();">
					    </div>
					    <div class="form-group col-md-2">
					      <label for="age">Total Age</label>
					      <input type="text" class="form-control" name="age" id="age" value="{{$cust->age}}">
					    </div>
				  	</div>
				  	<div class="row">
					    <div class="form-group col-md-6 col-lg-6 col-12">
						    ...
						    <!--<div class="row">-->
    						    <div class="form-group"> 
    						      <div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
    						        <input type="radio" id="customRadioInline1" name="gender" class="custom-control-input" value="Male" {{ ($cust->gender=="Male")? "checked" : "" }}>&nbsp;&nbsp;
    						        <label class="custom-control-label" for="customRadioInline1">Male</label>
    						      </div>
    							  <div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
    						        <input type="radio" id="customRadioInline2" name="gender" class="custom-control-input" value="Female" {{ ($cust->gender=="Female")? "checked" : "" }}>&nbsp;&nbsp;
    						        <label class="custom-control-label" for="customRadioInline2">Female</label>
    						      </div>
    						      <div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
    						        <input type="radio" id="customRadioInline3" name="gender" class="custom-control-input" value="Other" {{ ($cust->gender=="Other")? "checked" : "" }}>&nbsp;&nbsp;
					  	...
					  	<div class="form-group col-md-6">
					  		...
					  		<div class="form-group">
						  		<div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  			<input type="radio" id="unmarried" name="marital_status" class="custom-control-input" value="Unmarried" {{ ($cust->marital_status=="Unmarried")? "checked" : "" }}>&nbsp;&nbsp;
						  			<label class="custom-control-label" for="unmarried">Unmarried</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  			<input type="radio" id="married" name="marital_status" class="custom-control-input" value="Married" {{ ($cust->marital_status=="Married")? "checked" : "" }}>&nbsp;&nbsp;
						  			<label class="custom-control-label" for="married">Married</label>
								</div>
								<div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  			<input type="radio" id="Divorced" name="marital_status" class="custom-control-input" value="Divorced" {{ ($cust->marital_status=="Divorced")? "checked" : "" }}>&nbsp;&nbsp;
				  	...
				  	<div class="row">
				  		<div class="form-group col-md-6">
				    		...
				    		<!--<input type="text" class="form-control" id="religion" name="religion" value="{{$cust->religion}}">-->
				    		<select class="form-select" id="religion" name="religion" aria-label="Default select example">
							  <option value="{{$cust->religion}}">{{$cust->religion}}</option>
				  		...
				  		<div class="form-group col-md-6">
							...
							<!--<input type="text" name="medi_pref" class="form-control" value="{{$cust->medicin_pref}}">-->
							<select class="form-select" id="medi_pref" name="medi_pref" aria-label="Default select example">
							  <option value="{{$cust->medicin_pref}}">{{$cust->medicin_pref}}</option>
				    ...
				    <div class="row"> 
					    <div class="form-group col-md-6">
					     	<label for="Profession">Profession</label>
				      		<input type="text" name="prof" id="prof" class="form-control" value="{{$cust->profession}}">
					   	</div>
				     	<div class="form-group col-md-6">
				  			<label for="Reference">Reference :</label>
						    <input type="text" name="reference" id="reference" class="form-control" value="{{$cust->reference}}">
				  		</div>
					</div>
					<div class="row">
					  	<div class="form-group col-md-6">
					  		<label for="weight">Weight in Kg</label>
							<input type="number" name="wik" id="wik" class="form-control" value="{{$cust->weight_in_kg}}">
					  	</div>
				  		<div class="form-group col-md-6"><label for="height">Height in Cm</label>
							<input type="number" name="hic" id="hic" class="form-control" value="{{$cust->height_in_cm}}">
						</div>
					...
					<div class="row">
					  	<div class="form-group col-md-6">
					      	...
					      	<input type="text" class="form-control" id="address" name="address" onchange="setStates()"  value="{{$cust->address}}">
					    </div>
					       <!-- <label for="Contact Details"> Contact Details</label> -->
					   	<div class="form-group col-md-6">
					      	<label for="Mobile No">State</label>
					      	@if($cust->state == NULL)
    					      	<select class="form-select" name="state" id="st" onchange="print_city('state', this.selectedIndex);">
    								<option selected>Select State</option>
    							</select>
    							@else
    							<select class="form-select" name="state" id="st1" onchange="print_city('state', this.selectedIndex);">
    								<option value="{{$cust->state}}">{{$cust->state}}</option>
    							</select>
    							@endif
					      	 <!--<input type="hidden" class="" value="{{$cust->state}}" name="state1" id="st1" onchange="print_city('state', this.selectedIndex);" > -->
					 ...
					 <div class="row">
				  		 <div class="form-group col-md-3">
					      	...
					      	<option value="{{$cust->city}}">{{$cust->city}}</option>
					      	</select>
					    </div>
					    ...
					    <div class="form-group col-md-3">
					      	...
					      	<input type="text" class="form-control" name="pin" id="inputZip" value="{{$cust->pincode}}">
					    </div>
				  		
					    <div class="form-group col-md-6">
					      	<label for="Mobile No">Mobile No</label>
					      	<input type="number" class="form-control" id="mobile" name="mobile_no" value="{{$cust->mobile_no}}" readonly>
					    </div>
				  	...
				  	<div class="row">
				  		<div class="form-group col-md-6">
				      	    ...
				      	    <input type="hidden" class="form-control" name="password" id="password" value="{{$cust->password}}">
					    </div>  
				        <div class="form-group col-md-6">
				      	    ...
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text" style="width:100%" ></span>
        				      	     <input type="text" name="image1" id="image1" value="{{$cust->image}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="image" id="image" />
                                 </div>
				      	    </div>
				      	</div>
				      		<!--<input type="file" class="form-control" name="image" id="image"  onkeyup="Get_Percent()">-->
				      		<!--<input type="hidden" class="form-control" id="image1" name="image1" value="{{$cust->image}}">-->
				    	</div>
				    	<div class="form-group col-md-6">
					...
					<div class="form-group col-md-12 mt-1 rrb" >
					  <center> <input type="submit" name="submit" class="btn btn-outline-info btn1" value="Update"></center>
					</div>
...
<script>
	(function($) {
        $('input[name="image"]').on('change', function() {
            $('#image1').hide();
            $('#img_text').show();
            $("#img_text").html($('input[name="image"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
...
document.getElementById('st1').value = setStates();
