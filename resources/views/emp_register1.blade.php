...
@include('mainnav')
        ...
        <div class="container">
          <br>
       <center><h5 class="modal-title" style="font-weight: bold; color: white;" >EMPLOYEE REGISTRATION</h5></center> 
        <br>
  ...
  <label class="custom-control-label" for="customRadioInline3">Other</label>
   ...
   <div class="form-row">
    ...
    <div class="form-group col-md-6"><span class="required" style="color: red;">*</span>
      <label for="pan_uid">PAN Card / Aadhar Card</label>
      <input type="text" class="form-control" name="pan_uid" placeholder="PAN Card / Aadhar Card" required>
    </div>
  </div>
