...
<div class="container">
  <div class="container px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto" id="resetpassword">
    <form method="post" action="{{ url('/confirm_password') }}" class="basicform logincontent form-horizontal" id="form" enctype="multipart/form-data">
    @csrf
    <div class="card card0 border-0">
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 ">
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="img/logo3.png" class="image"> </div>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0">
                    <div class="row mb-4 px-3">
                        <h2 class="mb-0 mr-4 mt-2">Reset Password</h2>
                    </div>
