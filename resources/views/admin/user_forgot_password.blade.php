...
<form action="/user_change_password" method="post" class="">
@csrf
		...
		<!--					</div>-->
							<div class=" row justify-content-center"> 
								<div class="text-center ">
									<h2 class="index_header text-danger">FORGOT PASSWORD</h2>
                            ...
                            @endif
							  ...
							  <div class="mt-2"> <!-- form group-->
								<!--	 <LABEL FOR="EMAIL" CLASS="COL-MD-4 COL-FORM-LABELTEXT-MD-RIGHT">{{__('e-mAIL aDDRESS') }}</LABEL> -->
										...
										<input  type="text"  name="hi_mobile" class=" "  value="{{ $user }}" readonly>
										</div>
							...
							<div class=" row justify-content-center mt-2"> 
							  <div class="mt-2"> <!-- form group-->
								<!--	 <LABEL FOR="EMAIL" CLASS="COL-MD-4 COL-FORM-LABELTEXT-MD-RIGHT">{{__('e-mAIL aDDRESS') }}</LABEL> -->
										...
										<input id="password" type="password" for="password" name="password" class="form-control form-control-lg text_box_radius  @error('password') is-invalid @enderror text_box"  placeholder="Password" required>
										</div>
						 ...
						 <div class=" row justify-content-center mt-2"> 
							  <div class="mt-2"> <!-- form group-->
										...
										<input type="cpassword" for="cpass" name="cpassword" class="form-control form-control-lg text_box_radius @error('cpassword') is-invalid @enderror text_box" id="cpassword" placeholder="Confirm password"  required autocomplete="current-password">
										</div>
							...
							<div class="row justify-content-center"> <!-- row-->
								<div class="col-8"> <!-- col-6-->
									<div class="row justify-content-center"> <!-- row-->
									  <div class="col-lg-4 ">
										 <button type="submit" class="btn btn-sm btn-block btn-primary  login_button" style="background-image:url('img/login2.png'); "> {{ __('Update Password') }}</button>
									  </div>
								  </div><!-- row-->
							  </div><!-- col-6-->
						   </div> <!-- row-->
