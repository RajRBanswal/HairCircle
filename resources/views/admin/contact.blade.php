        ...
        <div class="row  justify-content-center">
            <div class="col mt-5">
                <div class="jumbotron"> <!-- jumbotron -->
                    ...
                    <p class="lead">Company Name: Evergoal India Pvt.Ltd <br>
                    Email Id: support@evergoalindia.com <br>
                    Contact Number: 7798770303 <br>
                        <Address>Address: <br>Plot No 53/01, Gadheghavan Jafferabad,<br>
                        Jalna 431208, India <br>
                        Ph.Res. Off: Plot No 53/01, Gadheghavan, Jalna
                        </Address>
                    </p>
