...
<form action="/forgot_pass_mobile" method="post" class="">
@csrf
					 ...
					 <div class=" m-3 ">  <!-- m-3-->
								...
								<!--	 <LABEL FOR="EMAIL" CLASS="COL-MD-4 COL-FORM-LABELTEXT-MD-RIGHT">{{__('e-mAIL aDDRESS') }}</LABEL> -->
										 <div class="input-group mb-2">
											 <div class="input-group-prepend">
											  ...
											  <input  type="number"  name="user_mobile" class="form-control form-control-lg text_box_radius text_box "  placeholder="XXX-XXX-XXXX" required>
							...
							<div class="row justify-content-center"> <!-- row-->
								<div class="col-8"> <!-- col-6-->
									<div class="row justify-content-center"> <!-- row-->
									  <div class="col-lg-4 ">
										 <button type="submit" class="btn btn-sm btn-block   login_button" style="background-image:url('img/login2.png'); "> {{ __('Submit') }}</button>
									  </div>
								  </div><!-- row-->
							  </div><!-- col-6-->
						   </div> <!-- row-->
