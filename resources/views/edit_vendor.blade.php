...
<div class="container">
	<div class="card mb-5 mt-3">
		<h3 class="mt-3 ml-3">Edit Profile</h3>

		<div class="card-body">
		    @foreach($vendor as $vdr)
			<form method="post" action="{{ url('/update_vendor_profile',$vdr->id) }}" class="basicform" enctype="multipart/form-data">
     		@csrf
     		    <div class="row">
     		        <h3>Owner Details</h3>
     		    </div>
     			<div class="row">
				    <div class="form-group col-md-6 col-lg-6 col-12">
				      ...
				      <input type="text" class="form-control" id="name" name="name" value="{{$vdr->name}}">
				    </div>
    				<div class="form-group col-md-6 col-lg-6 col-12">
					  <div>
					  ...
					  <div class="form-group"> 
						  <div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  	<input type="radio" id="customRadioInline1" name="gender" class="custom-control-input" value="Male" {{ ($vdr->gender=="Male")? "checked" : "" }}>&nbsp;&nbsp;
						  	<label class="custom-control-label" for="customRadioInline1">Male</label>
						  </div>
						<div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  <input type="radio" id="customRadioInline2" name="gender" class="custom-control-input" value="Female" {{ ($vdr->gender=="Female")? "checked" : "" }}>&nbsp;&nbsp;
						  <label class="custom-control-label" for="customRadioInline2">Female</label>
						</div>
						<div class="custom-control custom-radio custom-control-inline col-md-3 col-lg-3 col-12">
						  <input type="radio" id="customRadioInline3" name="gender" class="custom-control-input" value="Other" {{ ($vdr->gender=="Other")? "checked" : "" }}>&nbsp;&nbsp;
    			...
    			<div class="row">
				    <div class="form-group col-md-6 col-lg-6 col-12">
				      	...
				      	<input type="text" class="form-control" name="address" id="address" value="{{$vdr->address}}" onkeyup="setStates();">
				    </div>
				    <div class="form-group col-md-6 col-lg-6 col-12"> 
						<label for="state">State</label>
					      	<select class="form-select form-control" name="state" id="st" onchange="print_city('state', this.selectedIndex);"
					      	>
								<option value="{{$vdr->state}}">{{$vdr->state}}</option>
							</select>
				    </div>
				</div>
				<div class="row">
					    ...
					    <div class="row">
						    <div class="form-group col-md-6 col-lg-6 col-12">
					      	...
					      	<select id ="state" class="form-control" name="city">
					      	    <option value="{{$vdr->city}}">{{$vdr->city}}</option>
						    ...
						    <div class="form-group col-md-6 col-lg-6 col-12">
						      	...
						      	<input type="text" class="form-control" name="pin" id="inputZip" value="{{$vdr->pincode}}">
						    </div>
					    </div>  
				    </div>
				    <div class="form-group col-md-6 col-lg-6 col-12">
				    	<label for="Mobile No">Mobile No</label>
				      	<input type="number" class="form-control" name="mobile_no" id="mobile" value="{{$vdr->mobile_no}}" readonly>
				    </div>
				 </div>
  				<div class="row">
  				    <div class="form-group col-md-6 col-lg-6 col-12">
				      	<label for="email">Email</label> 
				      	<input type="email" class="form-control" name="email" id="email" value="{{$vdr->email}}">
				      	<input type="hidden" class="form-control" name="password" id="password" value="{{$vdr->password}}">
				    </div>
				  </div>
				  ...
				  <div class="row">
				    <div class="form-group col-md-6 col-lg-6 col-12">
				      	...
				      	<input type="text" class="form-control" id="shop_name" name="shop_name" value="{{$vdr->shop_name}}">
				    </div>
				    <!--<div class="form-group col-md-6 col-lg-6 col-12">-->
        <!--				  <label for="Shop License">License</label>-->
        <!--				  <input type="text" class="form-control" id="s_license" name="s_license" value="{{$vdr->shop_license}}" >-->
        <!--			</div>-->
    			
    			    <div class="form-group col-md-6 col-lg-6 col-12">
				      	<label for="Shop Logo">Shop Logo</label>
				      	<!--<input type="file" class="form-control" name="shoplogo" id="shop_logo" >-->
				      	<!--<input type="hidden" name="shoplogo1" id="shop_logo1" value="{{$vdr->shop_logo}}">-->
				      	<div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text" ></span>
        				      	     <input type="text" name="shoplogo1" id="shop_logo1" value="{{$vdr->shop_logo}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="shoplogo" id="image"/>
                                 </div>
				      	    </div>
				      	</div>
				    </div>
    			...
    			<div class="row text-line">
    			    <div class="form-group col-md-6 col-lg-6 col-12">
        			  	<label for="Shop License">Mobile No.</label>
        			  	<input type="number" class="form-control" id="phone" onfocusout="validatestudPhone()" name="phone" value="{{$vdr->phone}}">
        			</div>
    			
  				    <div class="form-group col-md-6 col-lg-6 col-12">
      					<label for="pan">Profile Image</label>
      				    <div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text1" style="width:100%"></span>
        				      	     <input type="text" name="profile1" id="profile1" value="{{$vdr->p_image}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="profile" id="profile" />
                                 </div>
				      	    </div>
				      	</div>
      					<!--<input type="file" class="form-control" name="profile" id="profile"  placeholder="Choose Files">-->
      					<!--<input type="text" class="form-control" name="profile1" id="profile1" value="{{$vdr->p_image}}">-->
    				</div>
    				
    			</div>
    			<div class="row text-line">
    				<div class="form-group col-md-6 col-lg-6 col-12">
				      	<label for="License">Shop Act License Image</label>
				      	<div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text2" style="width:100%"></span>
        				      	     <input type="text" name="lice1" id="lice1" value="{{$vdr->license}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="lice" id="lice" />
                                 </div>
				      	    </div>
				      	</div>
				      	<!--<input type="file" class="form-control" name="lice" id="lice" placeholder="Choose File" onkeyup="Get_Percent();">-->
				      	<!--<input type="hidden" class="form-control" name="lice1" id="lice1" value="{{$vdr->license}}" >-->
				    </div>
    			    <div class="form-group col-md-6 col-lg-6 col-12">
				      	...
				      	<div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text3" style="width:100%"></span>
        				      	     <input type="text" name="adhar1" id="adhar1" value="{{$vdr->adhar}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="adhar" id="adhar" />
                                 </div>
				      	    </div>
				      	</div>
				      	<!--<input type="file" class="form-control" name="adhar" id="adhar" placeholder="Choose File" >-->
				      	<!--<input type="hidden" class="form-control" name="adhar1" id="adhar1" value="{{$vdr->adhar}}">-->
				    </div>
				</div>	
    			<div class="row text-line">
    			    <div class="form-group col-md-6 col-lg-6 col-12">
      					...
      					<div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text4" style="width:100%"></span>
        				      	     <input type="text" name="pan1" id="pan1" value="{{$vdr->pan}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="pan" id="pan" />
                                 </div>
				      	    </div>
				      	</div>
      					<!--<input type="file" class="form-control" name="pan" id="pan"  placeholder="Choose Files">-->
      					<!--<input type="hidden" class="form-control" name="pan1" id="pan1" value="{{$vdr->pan}}">-->
    				</div>
				    <div class="form-group col-md-6 col-lg-6 col-12">
      					<label for="fssai">FSSAI Certificate </label>
      					<div class="row">
				      	    <div class="form-group">
        				      	 <div class="file-input-wrapper form-group d-flex">
        				      	     <span id="img_text5" style="width:100%" ></span>
        				      	     <input type="text" name="fssai1" id="fssai1" value="{{$vdr->fssai}}"/>
                                    <button type="button" class="btn btn-secondary">Choose_File</button>
                                    <input type="file" name="fssai" id="fssai" />
                                 </div>
				      	    </div>
				      	</div>
      					<!--<input type="file" class="form-control" name="fssai" id="fssai" placeholder="Choose Files">-->
      					<!--<input type="hidden" class="form-control" name="fssai1" id="fssai1" value="{{$vdr->fssai}}" >-->
    				</div>
    			</div>
    			<div class="row text-line">
				    <div class="form-group col-md-6 col-lg-6 col-12">
                        <label>FSSAI No.</label>
                        <input type="text" name="fssai_no" id="fssai_no" value="{{$vdr->fssai_no}}" class="form-control">
				    	<input type="hidden" class="form-control" name="point" id="points">
				    	<input type="hidden" class="form-control" name="point1" id="points1" value="{{$vdr->p_points}}">
					</div>
  				</div>
  				<div class="row mt-2 rrb">
  					<div class="form-group col-md-12 col-12 col-lg-12">
   						<center><button type="submit" class="btn btn-outline-primary btn1" >Update</button></center>
   					</div>
				</div>
			</form>
            @endforeach
...
#img_text,#img_text1,#img_text2,#img_text3,#img_text4,#img_text5{
    float: right;
    /*margin-left: 0px;*/
    margin-top: 5px;
...
#shop_logo1,#profile1,#lice1,#adhar1,#pan1,#fssai1{
     border: solid 1px lightgray;
    border-radius: 5px; 
    width:100%;
}
...
<script>
	(function($) {
        $('input[name="shoplogo"]').on('change', function() {
            $('#shop_logo1').hide();
            $('#img_text').show();
            $("#img_text").html($('input[name="shoplogo"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
    (function($) {
        $('input[name="profile"]').on('change', function() {
            $('#profile1').hide();
            $('#img_text1').show();
            $("#img_text1").html($('input[name="profile"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
      (function($) {
        $('input[name="lice"]').on('change', function() {
            $('#lice1').hide();
            $('#img_text2').show();
            $("#img_text2").html($('input[name="lice"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
      (function($) {
        $('input[name="adhar"]').on('change', function() {
            $('#adhar1').hide();
            $('#img_text3').show();
            $("#img_text3").html($('input[name="adhar"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
      (function($) {
        $('input[name="pan"]').on('change', function() {
            $('#pan1').hide();
            $('#img_text4').show();
            $("#img_text4").html($('input[name="pan"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
<script>
         (function($) {
        $('input[name="fssai"]').on('change', function() {
            $('#fssai1').hide();
            $('#img_text5').show();
            $("#img_text5").html($('input[name="fssai"]').val().replace("C:\\fakepath\\", ""));
        });
    })(jQuery);
</script>
...
<script type="text/javascript">
	function Get_Percent(){
		...
		$(document).ready(function() {
			...
			var s_license = document.getElementById('s_license').value;
			if (s_license != '') {temp = temp+5;}
			var shop_logo = document.getElementById('shop_logo').value;
			var shop_logo1 = document.getElementById('shop_logo1').value;
			if (shop_logo != '' || shop_logo == '' || shop_logo1 != '') {temp = temp+5;}
			...
			if (profile != '' || profile == '' || profile1 != '') {temp = temp+5;}
			var adhar = document.getElementById('adhar').value;
			var adhar1 = document.getElementById('adhar1').value;
			if (adhar != '' || adhar == '' || adhar1 != '') {temp = temp+5;}
			var pan = document.getElementById('pan').value;
			var pan1 = document.getElementById('pan1').value;
			if (pan != '' || pan == '' || pan1 != '') {temp = temp+5;}
			var fssai = document.getElementById('fssai').value;
			var fssai1 = document.getElementById('fssai1').value;
			if (fssai != '' || fssai == '' || fssai1 != '') {temp = temp+5;}
			var lice = document.getElementById('lice').value;
			var lice1 = document.getElementById('lice1').value;
			if (lice != '' || lice == '' || lice1 != '') {temp = temp+5;}
